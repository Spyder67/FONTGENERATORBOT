...
async def start(c, m):
    ...
    owner_username = owner.username if owner.username else 'Khush_xY'
...
** Developer by :** ❤️ ▷ [@Khush_xY(https://t.me/Khush_xY)
"""

    # Buttons
    buttons = [
        [
            InlineKeyboardButton('👥 Group', url=f"https://t.me/Hacking_Hubs"),
            InlineKeyboardButton('Channel 📢', url=f"https://t.me/Khush_xY")
            ],[
            InlineKeyboardButton('❤️ Credit', url=f"https://t.me/Khush_xY"),
            InlineKeyboardButton('Bot Lists Ask Owner🤖', url=f"https://t.me/Khush_xY"),
            InlineKeyboardButton('GitHup 🤣', url=f"https://github.com/Khushmeet-op")
            ],[
            InlineKeyboardButton('⚜️ Subscribe Now YouTube ⚜️', url=f"https://youtube.com/c/guruofgaming")
        ]
    ]
    await m.reply_text(
        text=text,
